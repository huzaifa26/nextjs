...
function Main(props) {
    ...
    return ( 
        <div>
            <input ref={quizTitle} style={{backgroundImage:'url(./titleIcon.png)'}} placeholder='Enter Quiz Name/Title' type={'text'}></input>
                <select ref={quizClass} style={{backgroundImage:'url(./classIcon.png)'}} id="class" name="class">
                ...
                <select ref={quizCourse} style={{backgroundImage:'url(./courseIcon.png)'}} id="course" name="course">
                    <option value="" disabled selected>Enter Course Name or Select</option>
