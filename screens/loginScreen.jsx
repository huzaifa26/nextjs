...
import {loginValidateSchema, signUpValidateSchema} from "../utlis/validations";
import Head from "next/head";
import {
  AlreadyAccount, AlreadyAccount_Ancher,
  BtnContainer,
  CheckBoxContainer, CheckBoxLabel,
  RemenberMeBox,
  SignupBox,
  SignupBoxContant, SignupFormContainer,
  SignupHead,
  SignupHeader,
  SignupHeading,
  SignupHeadingSpan,
  SignupImg, SignupInputBox, SignupTitle, TutorSignin
                ...
                >
                  <Form>
                    ...
                    <AlreadyAccount>
                      {t.haveAccount}{" "}
                      <Link href="/login">
                        <AlreadyAccount_Ancher>{t.getStarted}</AlreadyAccount_Ancher>
                      </Link>
                    </AlreadyAccount>
                  </Form>
                </Formik>
