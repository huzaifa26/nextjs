    ...
    <div>
        ...
        <div className={styles.quiz}>
                    ...
                    <div className={styles.buttonDiv}>
                        <button onClick={quizzezHandler} className={quizzes?styles.buttonActive:styles.buttonInactive}>
                            <img alt="" src={quizzes?"./darkquizzez.png":"./quizzez.png"}/>Quizzes<p>10</p>
                        </button>

                        <button onClick={createQuizHandler} className={createQuiz?styles.buttonActive:styles.buttonInactive}>
                            <img alt="" src={createQuiz?"./darkcq.png":"./cq.png"}/>Create Quiz <p>10</p>
                        </button>

                        <button onClick={draftsHandler} className={drafts?styles.buttonActive:styles.buttonInactive}>
                            <img alt="" src={drafts?"./darkdraft.png":"./drafts.png"}/>Drafts <p>10</p>
                        </button>

                        <button onClick={upcommingHandler} className={upcomming?styles.buttonActive:styles.buttonInactive}>
                            <img alt="" src={upcomming?"./darkupcomming.png":"./upcomming.png"}/>Upcoming <p>10</p>
                        </button>

                        <button onClick={completedHandler} className={completed?styles.buttonActive:styles.buttonInactive}>
                            <img alt="" src={completed?"./darkcompleted.png":"./completed.png"}/>Completed <p>10</p>
                        </button>
